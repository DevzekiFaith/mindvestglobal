...
export default function CatalogLeadSection() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setIsSuccess(true);
      // Automatically open the interactive Read-Me catalog modal upon approval
      setIsModalOpen(true);
    } catch (err: unknown) {
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center">
              ...
              {/* Checked Bullet Points - Price numbers removed for gated prestige */}
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-[#1e293b] text-xs font-mono text-slate-400">
                ...
                <span className="hidden sm:inline text-amber-500/80">DIRECT DISPATCH &amp; READ-ME VIEWER</span>
              </div>
            </div>
                  ...
                  <div className="py-6 text-center animate-fade-in flex flex-col items-center">
                    ...
                    <div className="w-full space-y-3 max-w-sm">
                      ...
                      <button
                        ...
                        className="w-full inline-flex items-center justify-center gap-2.5 py-4 px-6 rounded-lg bg-gradient-to-r from-[#b45309] via-[#d97706] to-[#f59e0b] text-[#0f172a] font-mono text-xs uppercase font-bold tracking-wider hover:brightness-110 active:scale-[0.99] transition-all shadow-lg shadow-amber-950/40"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                      ...
                      <a
                        ...
                        className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-lg bg-[#1e293b] hover:bg-[#334155] text-slate-200 border border-[#334155] font-mono text-xs uppercase tracking-wider transition-colors"
                      >
      ...
      {/* ========================================================================= */}
      {isModalOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 lg:p-10 bg-black/85 backdrop-blur-md animate-fade-in">
          {/* Modal Container */}
          <div className="relative w-full max-w-5xl max-h-[92vh] flex flex-col bg-[#0b1120] border border-[#334155] rounded-2xl shadow-2xl overflow-hidden text-slate-100">
            {/* Modal Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#1e293b] bg-[#0f172a]">
              <div className="flex items-center gap-3">
                <span className="px-2.5 py-1 rounded bg-[#b45309]/20 border border-[#b45309]/50 text-[#f59e0b] text-[10px] font-mono uppercase tracking-widest font-semibold">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#1e293b] hover:bg-[#334155] text-xs font-mono text-slate-200 border border-[#334155] transition-colors"
                >
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg bg-[#1e293b] hover:bg-[#334155] text-slate-300 hover:text-white flex items-center justify-center transition-colors"
            ...
            <div className="flex-1 overflow-y-auto p-6 sm:p-10 space-y-10 custom-scrollbar">
              ...
              <div className="border-b border-[#1e293b] pb-8">
                <div className="text-[#f59e0b] font-mono text-xs tracking-[3px] uppercase font-bold mb-2">
                  MINDVEST GLOBAL RESOURCES
                </div>
                <h1 className="text-2xl sm:text-4xl font-light text-white font-serif tracking-tight leading-tight">
              ...
              {/* Value Philosophy */}
              <div className="bg-[#131d33] border-l-4 border-[#f59e0b] p-5 sm:p-6 rounded-r-xl">
                <h3 className="text-xs font-mono uppercase tracking-widest text-[#f59e0b] font-bold mb-2">
              ...
              <div className="space-y-4">
                ...
                <div className="overflow-x-auto rounded-xl border border-[#1e293b] bg-[#0f172a]">
                  <table className="w-full text-left text-xs sm:text-sm">
                    <thead>
                      <tr className="border-b border-[#1e293b] bg-[#1e293b]/60 text-slate-300 font-mono text-[11px] uppercase tracking-wider">
                        <th className="py-3.5 px-4 sm:px-6">Service Line</th>
                        <th className="py-3.5 px-4 sm:px-6">Core Deliverables &amp; Scope</th>
                        <th className="py-3.5 px-4 sm:px-6">Target Client Profile</th>
                        <th className="py-3.5 px-4 sm:px-6 text-right">Investment Level</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-[#1e293b] text-slate-300">
                      <tr className="hover:bg-[#131d33] transition-colors">
                        <td className="py-4 px-4 sm:px-6 font-semibold text-white">
                          Executive Keynote Speaking
                          <div className="text-[11px] font-normal text-slate-400 font-mono">On-Site / Virtual Engagements</div>
                        </td>
                        <td className="py-4 px-4 sm:px-6 leading-relaxed">
                        ...
                        <td className="py-4 px-4 sm:px-6 text-right font-mono font-bold text-[#f59e0b] whitespace-nowrap">
                          ₦1,000,000 –<br />₦2,500,000
                          <div className="text-[10px] text-slate-400 font-normal">per keynote session</div>
                        </td>
                      </tr>
                      ...
                      <tr className="hover:bg-[#131d33] transition-colors">
                        <td className="py-4 px-4 sm:px-6 font-semibold text-white">
                          The Becoming Coaching
                          <div className="text-[11px] font-normal text-slate-400 font-mono">12-Week Executive Program</div>
                        </td>
                        <td className="py-4 px-4 sm:px-6 leading-relaxed">
                          Personal vision architecture, high-performance executive mindset, identity re-engineering, strategic personal branding, and elite accountability.
                        </td>
                        <td className="py-4 px-4 sm:px-6 text-slate-300">
                        ...
                        <td className="py-4 px-4 sm:px-6 text-right font-mono font-bold text-[#f59e0b] whitespace-nowrap">
                          ...
                          <div className="text-[10px] text-slate-400 font-normal">per coachee</div>
                        </td>
                      </tr>
                      ...
                      <tr className="hover:bg-[#131d33] transition-colors">
                        <td className="py-4 px-4 sm:px-6 font-semibold text-white">
                          ...
                          <div className="text-[11px] font-normal text-slate-400 font-mono">60–90 Day Transformation</div>
                        </td>
                        <td className="py-4 px-4 sm:px-6 leading-relaxed">
                          On-site executive alignment workshops, bespoke executive pipelines, succession planning, and decision-rights mapping.
                        </td>
                        <td className="py-4 px-4 sm:px-6 text-slate-300">
                          Expanding mid-market enterprises, scale-ups, and family-owned businesses.
                        </td>
                        <td className="py-4 px-4 sm:px-6 text-right font-mono font-bold text-[#f59e0b] whitespace-nowrap">
                          ₦2,500,000 –<br />₦5,000,000
                          <div className="text-[10px] text-slate-400 font-normal">flat project fee</div>
                        </td>
                      </tr>
                      ...
                      <tr className="hover:bg-[#131d33] transition-colors">
                        <td className="py-4 px-4 sm:px-6 font-semibold text-white">
                          ...
                          <div className="text-[11px] font-normal text-slate-400 font-mono">Full Restructuring / Retainer</div>
                        </td>
                        <td className="py-4 px-4 sm:px-6 leading-relaxed">
                        ...
                        <td className="py-4 px-4 sm:px-6 text-right font-mono font-bold text-[#f59e0b] whitespace-nowrap">
                          ...
                          <div className="text-[10px] text-slate-400 font-normal">or ₦1.5M–₦3M/mo retainer</div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="space-y-4">
                <h2 className="text-xl sm:text-2xl font-serif font-light text-white border-b border-[#1e293b] pb-2">
                  2. Detailed Service Scope &amp; Delivery Frameworks
                </h2>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {/* Pillar 1 */}
                  <div className="p-5 rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-[#f59e0b]/50 transition-colors">
                    <div className="text-[10px] font-mono uppercase tracking-widest text-[#f59e0b] font-bold mb-1">
                      KEYNOTE ADDRESS
                    </div>
                    <h4 className="text-base font-semibold text-white mb-2">Executive Speaking</h4>
                    <p className="text-xs text-slate-400 mb-4 leading-relaxed">
                      On-site keynotes and high-stakes executive retreat presentations.
                    </p>
                    <ul className="space-y-2 text-xs text-slate-300">
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> 60–90 min keynote presentation</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Customized event theme alignment</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Pre-event executive interview</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Audience Q&amp;A &amp; engagement</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> VIP strategy roundtable inclusion</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-5 rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-[#f59e0b]/50 transition-colors">
                    ...
                    <h4 className="text-base font-semibold text-white mb-2">The Becoming Coaching</h4>
                    <p className="text-xs text-slate-400 mb-4 leading-relaxed">
                      High-touch 1-on-1 intensive aligning personal authority with execution.
                    </p>
                    <ul className="space-y-2 text-xs text-slate-300">
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Weekly 90-min 1-on-1 coaching</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Executive personal audit</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Identity re-engineering</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Origin Platform publishing access</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> 24/7 strategic desk chat</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-5 rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-[#f59e0b]/50 transition-colors">
                    ...
                    <h4 className="text-base font-semibold text-white mb-2">Leadership Architecture</h4>
                    <p className="text-xs text-slate-400 mb-4 leading-relaxed">
                      Structuring the leadership engine &amp; on-site alignment workshops.
                    </p>
                    <ul className="space-y-2 text-xs text-slate-300">
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> On-site executive speaking</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Competency model mapping</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Succession planning blueprints</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> C-suite governance frameworks</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Board alignment workshops</li>
                    </ul>
                  </div>
                  ...
                  <div className="p-5 rounded-xl bg-[#0f172a] border border-[#1e293b] hover:border-[#f59e0b]/50 transition-colors">
                    ...
                    <h4 className="text-base font-semibold text-white mb-2">Organisational Architecture</h4>
                    <p className="text-xs text-slate-400 mb-4 leading-relaxed">
                      Total structural re-engineering to eliminate friction and maximize yield.
                    </p>
                    <ul className="space-y-2 text-xs text-slate-300">
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Full-scale corporate restructuring</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Process optimization &amp; workflows</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Culture &amp; performance systems</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Multi-division brand alignment</li>
                      <li className="flex items-center gap-2"><span className="text-[#f59e0b]">•</span> Quarterly board advisory seats</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              {/* Document Footer */}
              <div className="pt-6 border-t border-[#1e293b] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400 font-mono">
                <div>
                ...
                <div className="flex items-center gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 py-2 rounded bg-[#f59e0b] text-[#0f172a] font-bold uppercase tracking-wider hover:bg-amber-400 transition-colors"
                  >
